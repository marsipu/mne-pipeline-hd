...
@topline
def epoch_raw(sub, event_id, t_epoch, baseline, reject, flat, autoreject, overwrite_ar, decim):
...
@topline
def run_ica(sub, eog_channel, ecg_channel, reject, flat, autoreject, save_plots, figures_path, pscripts_path):
    info = sub.load_info()
...
# ==============================================================================
@topline
def setup_src(mri_sub, source_space_spacing, n_jobs):
